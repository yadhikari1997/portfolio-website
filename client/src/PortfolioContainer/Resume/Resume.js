...
export default function Resume(props) {
    ...
    const resumeDetails = [
        <div className="resume-screen-container" key="education">
            <ResumeHeading
                heading={"Texas Tech University, Texas"}
                subHeading={"BACHELOR OF SCIENCE,MINOR IN MATHEMATICS"}
                fromDate={"2019"}
                toDate={"2021"}
            />

            <ResumeHeading
                heading={"South Plains College"}
            ...
            <ResumeHeading
                heading={"High School "}
                subHeading={"Trinity Int'l College,Nepal"}
                fromDate={"2014"}
                toDate={"2016"}
            />
        </div>,
        ...
        <div className="resume-screen-container" key="work-experience">
            <div className="experience-container">
                <ResumeHeading
                    heading={"Texas Capital Bank, Dallas, Texas"}
